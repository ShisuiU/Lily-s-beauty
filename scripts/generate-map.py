#!/usr/bin/env python3
"""
Régénère src/assets/plan-salon.jpg à partir des coordonnées du salon.
...
LAT, LON = 44.1055174, 4.6590543          # doit rester en phase avec `geo` dans src/data/site.ts
ZOOM, WIDTH, HEIGHT = 17, 1200, 620
OUT = 'src/assets/plan-salon.jpg'
UA = 'LilysBeautySite/1.0 (build-time static map; github.com/ShisuiU/Lily-s-beauty)'
ROSE = (158, 90, 118)                      # --rose-ink
...
def main() -> None:
    ...
    draw.ellipse([mx - 26, my - 26, mx + 26, my + 26], fill=(*ROSE, 46))
    draw.ellipse([mx - 13, my - 13, mx + 13, my + 13], fill=(255, 255, 255, 255))
    draw.ellipse([mx - 9, my - 9, mx + 9, my + 9], fill=(*ROSE, 255))
